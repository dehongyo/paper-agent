  ...
  return (
    <section className="surface">
      ...
      <label className="field-label mb-3 block">
        <span className="mb-1.5 block">综述主题</span>
        <textarea
          value={topic}
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
        <label className="field-label">
          <span className="mb-1.5 block">写作类型</span>
        ...
        <label className="field-label">
          <span className="mb-1.5 block">输出语言</span>
        ...
        <label className="field-label">
          <span className="mb-1.5 block">目标篇幅</span>
        ...
        <label className="field-label">
          <span className="mb-1.5 block">引用格式</span>
